defmodule AccountabilityBuddyWeb.TasksControllerTest do
  use AccountabilityBuddyWeb.ConnCase

  import AccountabilityBuddy.AccountabilityFixtures

  @create_attrs %{description: "some description", priority: 42, title: "some title"}
  @update_attrs %{
